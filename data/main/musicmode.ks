...
[position layer=message1 frame="musicmode_base" opacity=255 left=560 top=240 width=800 height=600 marginT=0 marginL=0 marginR=0 marginB=0 visible=true  transparent=false page=back]
